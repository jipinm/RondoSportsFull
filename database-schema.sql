...
INSERT INTO `admin_users` (`id`, `name`, `email`, `password_hash`, `role_id`, `role`, `status`, `permissions`, `last_login_at`, `password_changed_at`, `email_verified_at`, `two_fa_enabled`, `two_fa_secret`, `failed_login_attempts`, `locked_until`, `created_by`, `created_at`, `updated_at`) VALUES
	...
	(3, 'Administrator', 'admin@example.com', '$2y$10$nrSSAKGq92Tu2JKtKiCvMeRnGkgP/dVzIBGNlAZfQ7Lg7Lvw9IDHS', 1, 'super_admin', 'active', NULL, '2026-01-27 11:25:24', '2025-10-20 10:30:18', NULL, 0, NULL, 0, NULL, NULL, '2025-10-01 13:09:32', '2026-01-27 11:25:24'),
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Content management system for website pages';

-- Dumping data for table rondo.cms_pages: ~3 rows (approximately)
INSERT INTO `cms_pages` (`id`, `page_key`, `title`, `slug`, `content`, `excerpt`, `status`, `meta_title`, `meta_description`, `meta_keywords`, `content_type`, `template`, `featured_image`, `published_at`, `scheduled_publish_at`, `last_edited_by`, `view_count`, `last_viewed_at`, `created_at`, `updated_at`) VALUES
	(1, 'terms', 'Terms and Conditions', 'terms-conditions', '<h1>Terms and Conditions</h1>\n<p><strong>Last updated:</strong> September 17, 2025</p>\n\n<h2>1. Acceptance of Terms</h2>\n<p>By accessing and using Rondo Sports ticket booking platform, you accept and agree to be bound by the terms and provision of this agreement.</p>\n\n<h2>2. Ticket Purchases</h2>\n<p>All ticket purchases are subject to availability and our booking policies. Prices are subject to change without notice until payment is confirmed.</p>\n\n<h2>3. Refund Policy</h2>\n<p>Refunds are subject to our refund policy and may include processing fees. Event cancellations will result in full refunds.</p>\n\n<h2>4. User Responsibilities</h2>\n<p>Users are responsible for providing accurate information and maintaining the security of their accounts.</p>\n\n<h2>5. Contact Information</h2>\n<p>For questions about these terms, please contact us at support@rondosports.com</p>', NULL, 'published', 'Terms and Conditions - Rondo Sports', 'Read the complete terms and conditions for Rondo Sports ticket booking platform.', NULL, 'rich_text', 'default', NULL, '2025-10-01 12:39:22', NULL, NULL, 0, NULL, '2025-10-01 12:39:22', '2025-10-01 12:39:22'),
	(2, 'privacy', 'Privacy Policy', 'privacy-policy', '<h1>Privacy Policy</h1>\n<p><strong>Last updated:</strong> September 17, 2025</p>\n\n<h2>1. Information We Collect</h2>\n<p>We collect information you provide directly to us, such as when you create an account, make a booking, or contact us for support.</p>\n\n<h2>2. How We Use Your Information</h2>\n<p>We use the information we collect to provide, maintain, and improve our services, process transactions, and communicate with you.</p>\n\n<h2>3. Information Sharing</h2>\n<p>We do not sell, trade, or otherwise transfer your personal information to third parties without your consent, except as described in this policy.</p>\n\n<h2>4. Data Security</h2>\n<p>We implement appropriate security measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction.</p>\n\n<h2>5. Your Rights</h2>\n<p>You have the right to access, update, or delete your personal information. Contact us at privacy@rondosports.com for data requests.</p>\n\n<h2>6. Contact Us</h2>\n<p>If you have any questions about this Privacy Policy, please contact us at privacy@rondosports.com</p>', NULL, 'published', 'Privacy Policy - Rondo Sports', 'Learn how Rondo Sports protects your privacy and handles your personal information.', NULL, 'rich_text', 'default', NULL, '2025-10-01 12:39:22', NULL, NULL, 0, NULL, '2025-10-01 12:39:22', '2025-10-01 12:39:22'),
	(3, 'about', 'About Rondo Sports', 'about-us', '<h1>About Rondo Sports</h1>\n\n<h2>Our Mission</h2>\n<p>Rondo Sports is dedicated to providing sports fans with easy access to the best sporting events around the world. We believe that everyone should have the opportunity to experience the thrill of live sports.</p>\n\n<h2>What We Offer</h2>\n<p>Our platform provides access to a wide variety of sporting events including:</p>\n<ul>\n<li>Football matches and tournaments</li>\n<li>Basketball games and championships</li>\n<li>Tennis tournaments</li>\n<li>Formula 1 racing</li>\n<li>Olympic events</li>\n<li>And much more!</li>\n</ul>\n\n<h2>Our Commitment</h2>\n<p>We are committed to providing:</p>\n<ul>\n<li>Secure and reliable ticket booking</li>\n<li>Competitive pricing</li>\n<li>Excellent customer service</li>\n<li>Easy refund and exchange policies</li>\n<li>Mobile-friendly experience</li>\n</ul>\n\n<h2>Contact Us</h2>\n<p>Have questions? We\'re here to help!</p>\n<p>Email: support@rondosports.com<br>\nPhone: +1 (555) 123-4567<br>\nHours: Monday-Friday 9AM-6PM EST</p>', NULL, 'published', 'About Rondo Sports - Your Sports Ticket Destination', 'Learn about Rondo Sports, your trusted platform for booking tickets to the world\'s best sporting events.', NULL, 'rich_text', 'default', NULL, '2025-10-01 12:39:22', NULL, NULL, 0, NULL, '2025-10-01 12:39:22', '2025-10-01 12:39:22');
...
) ENGINE=InnoDB AUTO_INCREMENT=63 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Customer JWT session management';
...
INSERT INTO `customer_sessions` (`id`, `customer_id`, `token_hash`, `refresh_token_hash`, `device_info`, `ip_address`, `expires_at`, `created_at`, `updated_at`) VALUES
	(62, 1, '81dfddc1e06fa30b80f1580eae3b86ce12608acfddc16b34a8785ad838345280', 'ed5a3ffe845e837ca4f0ed1fa302bf6a2be2b1b1fa380ff56046a771f63ad445', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36 Edg/144.0.0.0', '127.0.0.1', '2026-01-27 12:45:38', '2026-01-27 11:45:38', '2026-01-27 11:45:38');
...
INSERT INTO `customer_users` (`id`, `customer_id`, `first_name`, `last_name`, `email`, `phone`, `status`, `total_bookings`, `total_spent`, `average_booking_value`, `last_booking_at`, `first_booking_at`, `preferred_sports`, `marketing_consent`, `notes`, `blocked_reason`, `blocked_by`, `blocked_at`, `created_at`, `updated_at`, `password_hash`, `email_verified`, `email_verification_token`, `password_reset_token`, `password_reset_expires`, `last_login`, `street`, `house_number`, `zipcode`, `city`, `country_code`, `failed_login_attempts`, `locked_until`, `two_factor_enabled`, `two_factor_secret`, `date_of_birth`, `gender`) VALUES
	(1, 'CUST76619439', 'Jipin', 'Kumar M', 'jipinm@gmail.com', '8129836080', 'active', 0, 0.00, 0.00, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, '2025-10-18 07:20:06', '2026-01-27 11:45:38', '$2y$10$GllV7B9/jx.TsaAsH3G1ru/mONMjpdrz4w9ZFNQ0/sngddxSYZ0aC', 1, NULL, NULL, NULL, '2026-01-27 07:15:38', 'Pallickal', 'BP 2/668', '690503', 'Kayamkulam', 'IND', 0, NULL, 0, NULL, NULL, NULL),
...
-- Dumping structure for table rondo.static_pages
CREATE TABLE IF NOT EXISTS `static_pages` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `page_key` varchar(50) NOT NULL COMMENT 'Unique identifier for the page (terms, privacy)',
  `title` varchar(255) NOT NULL COMMENT 'Display title of the page',
  `content` longtext NOT NULL COMMENT 'HTML content of the page',
  `meta_title` varchar(255) DEFAULT NULL COMMENT 'SEO meta title',
  `meta_description` text DEFAULT NULL COMMENT 'SEO meta description',
  `meta_keywords` text DEFAULT NULL COMMENT 'SEO keywords',
  `status` enum('active','inactive') DEFAULT 'active' COMMENT 'Page status',
  `is_published` tinyint(1) DEFAULT 1 COMMENT 'Whether the page is published',
  `slug` varchar(255) NOT NULL COMMENT 'URL slug for the page',
  `created_by` bigint(20) unsigned DEFAULT NULL COMMENT 'Admin user who created the page',
  `updated_by` bigint(20) unsigned DEFAULT NULL COMMENT 'Admin user who last updated the page',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  PRIMARY KEY (`id`),
